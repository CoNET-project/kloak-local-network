...
export class qtGateImap extends Event.EventEmitter {
    ...
    constructor ( public IMapConnect: IImapConnect, public listenFolder: string, public deleteBoxWhenEnd: boolean, public writeFolder: string, private debug: boolean, public newMail: ( mail ) => void, private skipOldMail = true ) {
        super ()
        this.connect ()
        this.once ( `error`, err => {
...
export const seneMessageToFolder = ( IMapConnect: IImapConnect, writeFolder: string, message: string, subject: string, createFolder: boolean, CallBack ) => {
...
export class qtGateImapRead extends qtGateImap {
    ...
    constructor ( IMapConnect: IImapConnect, listenFolder: string, deleteBoxWhenEnd: boolean, newMail: ( mail ) => void, skipOldMail = false ) {
...
export const imapAccountTest = ( IMapConnect: IImapConnect, CallBack ) => {
...
export const imapGetMediaFile = ( IMapConnect: IImapConnect, fileName: string, CallBack ) => {
...
export class imapPeer extends Event.EventEmitter {
    ...
    constructor ( public imapData: IImapConnect, private listenBox: string, private writeBox: string, public newMail, public exit: ( err?: number ) => void ) {
        super ()
